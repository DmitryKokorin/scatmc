...
const Float IndicatrixApp::thetaMax = 1e-5;

IndicatrixApp::IndicatrixApp() 
{
...
void IndicatrixApp::processScattering(const Photon& ph)
{
    #pragma omp critical
	{
...
void IndicatrixApp::run()
{
	...
	Partition p;
	preparePartition(p); //TODO: move this code to Partition c'tor
